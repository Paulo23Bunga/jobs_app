...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a id="btn-prod" class="nav-link active" href="#">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2 class="my-2">Prestadores Registrados</h2>
      ...
      <table class="table table-striped table-sm ">
          ...
          <tbody>
    <?php
          $sqlBusca1 = "SELECT * FROM tb_prestador";
    ...
    ?>
            ...
            <tr>
              ...
              <td class="d-flex align-items-center"><img src="../img/<?php echo $tarefa1['img_prestador']; ?>" alt="" style="width: 50px; height: 50px;" class="rounded img-thumbnail" ><span class="px-1 text-muted"><b>
