...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a id="btn-venda" class="nav-link active" href="#">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-none d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      ...
      <h2 class="my-2">Clientes Cadastrados</h2>
      ...
      <table class="table table-striped table-sm ">
          <thead >
            ...
            <th scope="col">#</th>
              ...
              <th scope="col" style="">contacto</th>
          ...
          <tbody>
    <?php
          $sqlBusca1 = "SELECT * FROM tb_cliente";
    ...
    ?>
            ...
            <tr>
              ...
              <td class="d-flex align-items-center"><img src="../img/<?php echo $tarefa1['img_cliente']; ?>" alt="" style="width: 50px; height: 50px;" class="rounded img-thumbnail" ><span class="px-1 text-muted"><b>
                <?php echo $tarefa1['nome_cliente']; ?>
              </b></span></td>
              <td>
              <?php echo $tarefa1['numero_cliente']; ?>
              </td>
              <td>
              <?php echo $tarefa1['endereco_cliente']; ?>
              </td>
              <td>
                <a href="#">
